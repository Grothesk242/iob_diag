...
clear;
echo -e "ioBroker nodejs maintenance $VERSION";
...
then
        ...
        then
                ...
                $SUDOX find / \( -path /proc -o -path /dev -o -path /backup -o -path /sys -o -path /lost+found -o -path /mnt -o -path /run \) -prune -false -o -name nodesource.[gk]* -exec "$SUDOX rm {} "\;
